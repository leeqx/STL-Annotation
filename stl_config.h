...
# else
#   define __STD                            // Conghui: expand to nothing
#   define __STL_BEGIN_NAMESPACE            // Conghui: expand to nothing
#   define __STL_END_NAMESPACE              // Conghui: expand to nothing
#   undef  __STL_USE_NAMESPACE_FOR_RELOPS
#   define __STL_BEGIN_RELOPS_NAMESPACE     // Conghui: expand to nothing
#   define __STL_END_RELOPS_NAMESPACE       // Conghui: expand to nothing
#   define __STD_RELOPS
#   undef  __STL_USE_NAMESPACES             // Conghui: undefine it
# endif
